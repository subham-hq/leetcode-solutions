...
The progress table, solutions index, and directory tree are generated automatically. A GitHub Action runs [`scripts/update_readme.py`](./scripts/update_readme.py) on every push, keeping each section in sync with the solutions committed to this repository.
